...
void System::drawDebugString()
{
    ...
    DrawFormatString(270, 40, cr, "bubbleSpeedX%f", I_PlBubbleObj[0].speed.x);
    DrawFormatString(270, 60, cr, "bubbleSpeedY%f", I_PlBubbleObj[0].speed.y);
    DrawFormatString(270, 80, cr, "touchBubble[0]%d", I_PlBubbleObj[0].touchBubble);
    DrawFormatString(270, 100, cr, "touchBubble[1]%d", I_PlBubbleObj[1].touchBubble);
    DrawFormatString(270, 120, cr, "touchBubble[2]%d", I_PlBubbleObj[2].touchBubble);
    DrawFormatString(270, 140, cr, "touchBubble[3]%d", I_PlBubbleObj[3].touchBubble);
    DrawFormatString(270, 160, cr, "level[0]%d", I_PlBubbleObj[0].level);
    DrawFormatString(270, 180, cr, "centerX  %f", I_PlBubbleObj[0].center.x);
    DrawFormatString(270, 200, cr, "centerY  %f", I_PlBubbleObj[0].center.y);
    DrawFormatString(270, 220, cr, "Stage_Select.size:%f", M_Stage_Select.size);
    DrawFormatString(270, 240, cr, "Stage_Select.select:%d", M_Stage_Select.select);
}
